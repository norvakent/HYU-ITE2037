...
public class CarRentalSystem {
  private Car[] cars;             // list of cars in the system
  ...
  private RentalOrder[] orders;   // list of rental orders
  ...
  public void rentCar(String customerName, int carIndex, int rentalDays) {
    ...
    if (!this.cars[carIndex].isAvailable()) {
    ...
    while (option != 7) {
      ...
      switch (option) {
        ...
        case 7: // exit the program
          // entering 7 will exit the loop and the program
